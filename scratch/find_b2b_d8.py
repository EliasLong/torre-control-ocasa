...
SHEETS = [
    ...
    {'name': 'B2B PL2', 'id': '1qSptp0U_8fuo_bAcsQtsLl5ROVzCN44kZHKuEHC24vI', 'gid': '1832488493', 'dispatchCol': 16, 'bultosCols': [8], 'dateCol': 0, 'b2c': False},
    {'name': 'B2B PL3', 'id': '1qSptp0U_8fuo_bAcsQtsLl5ROVzCN44kZHKuEHC24vI', 'gid': '2114457503', 'dispatchCol': 16, 'bultosCols': [8], 'dateCol': 0, 'b2c': False},
]
    ...
    for s in SHEETS:
        ...
        for i, row in enumerate(reader):
            ...
            if actual_dispatch == '18/05':
                if not s['b2c']:
                    print(f"B2B DISPATCH on 18/05: {s['name']} Row {i+1}")
